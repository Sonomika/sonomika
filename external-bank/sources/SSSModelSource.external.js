// Portable external SSS Model Source (no imports). Uses globals: window.React, window.THREE, window.r3f
// Note: Relies on THREE examples classes being attached to global THREE if available.
...
export const metadata = {
  name: 'SSS Model Source (External)', description: 'FBX model using Subsurface Scattering shader.', category: 'Sources', author: 'VJ System', version: '1.0.0', isSource: true,
  parameters: [
