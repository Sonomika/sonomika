// Portable external PCD Point Cloud Source (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'PCD Point Cloud (External)', description: 'Animated 3D point cloud with BPM sync.', category: '3D', author: 'VJ System', version: '1.0.0', replacesVideo: false, isSource: true,
  parameters: [
...
export default function PCDPointCloudSourceExternal({ pointSize=0.005, pointColor='#ffffff', rotationSpeed=0.5, scale=1.0, autoRotate=true, bpmSync=false, intensity=0.5 }){
