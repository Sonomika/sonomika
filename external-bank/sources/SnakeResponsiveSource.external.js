// Portable external Snake Responsive Source (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'Snake Responsive Source (External)', description: 'Auto snake that adapts to canvas size.', category: 'Sources', author: 'VJ System', version: '1.0.0', isSource: true,
  parameters: [
