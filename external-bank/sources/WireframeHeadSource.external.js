// Portable external Wireframe Head Source (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'Wireframe Head Source (External)', description: 'Edge-thickness wireframe of BufferGeometry JSON.', category: 'Sources', author: 'VJ System', version: '1.0.0', isSource: true,
  parameters: [
...
export default function WireframeHeadSourceExternal({ modelUrl='https://cdn.jsdelivr.net/gh/mrdoob/three.js@dev/examples/models/json/WaltHeadLo_buffergeometry.json', thickness=1, showLeftBasic=true }){
