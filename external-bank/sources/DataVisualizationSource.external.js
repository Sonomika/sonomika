// Portable external Data Visualization Source (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'Data Visualization (External)', description: 'Animated HUD-style text and lines with BPM pulse.', category: 'Data', author: 'VJ System', version: '1.0.0', folder: 'sources', isSource: true,
