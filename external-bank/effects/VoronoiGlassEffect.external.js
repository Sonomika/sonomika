// Portable external Voronoi Glass effect (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'Voronoi Glass (External)', description: 'Voronoi refraction with dispersion and edges.', category: 'Distortion', author: 'VJ System', version: '1.0.0', replacesVideo: true, canBeGlobal: true,
  parameters: [
