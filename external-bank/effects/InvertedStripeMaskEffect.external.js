// Portable external Inverted Stripe Mask effect (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'Inverted Stripe Mask (External)', description: 'Scrolling angled stripes as inverted mask.', category: 'Video Effects', author: 'VJ System', version: '1.0.0', replacesVideo: true, canBeGlobal: true,
