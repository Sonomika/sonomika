// Portable external Blob Detection Source (no imports). Uses globals: window.React, window.THREE, window.r3f
// NOTE: In external mode, we implement a simplified visualization-only blob display.
