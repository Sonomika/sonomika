...
export default function DataVisualizationSource({ color='#00ff00', intensity=1.0, speed=1.0, textCount=24, lineCount=16 }){
  ...
  return React.createElement('group',{ref:groupRef},
    textElements.map((e,i)=> React.createElement(HUDText,{ key:e.id, position:e.position, text: (i<dynamicTexts.length?dynamicTexts[i]:e.text), color, intensity, speed, phase:e.phase, elementSpeed:e.speed })),
    lineElements.map((e)=> React.createElement(HUDLine,{ key:e.id, start:e.start, end:e.end, color, intensity, speed, phase:e.phase, elementSpeed:e.speed })),
...
function HUDText({ position, text, color, intensity, speed, phase, elementSpeed }){
...
function HUDLine({ start, end, color, intensity, speed, phase, elementSpeed }){
