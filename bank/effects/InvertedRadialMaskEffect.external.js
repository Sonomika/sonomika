// Portable external Inverted Radial Mask effect (no imports). Uses globals: window.React, window.THREE, window.r3f
...
export const metadata = {
  name: 'Inverted Radial Mask (External)', description: 'Inverted animated ring mask with wobble.', category: 'Video Effects', author: 'VJ System', version: '1.0.0', replacesVideo: true, canBeGlobal: true,
