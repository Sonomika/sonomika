...
export const DragTest: React.FC = () => {
  ...
  return (
    <div className="tw-p-8 tw-bg-neutral-900 tw-text-white tw-min-h-screen">
      <h1 className="tw-text-2xl tw-font-bold tw-mb-6">Drag Test</h1>
      
      <div className="tw-mb-4">
        <h2 className="tw-text-lg tw-font-semibold tw-mb-2">Test Simple Timeline Clip Dragging</h2>
        <p className="tw-text-sm tw-text-neutral-400 tw-mb-4">
          Try dragging the clips below. They should move horizontally and update their start time.
        </p>
      </div>
