...
function createMirrorWindow() {
    ...
    mirrorWindow = new electron_1.BrowserWindow({
        ...
        webPreferences: {
            ...
            webSecurity: false,
            allowRunningInsecureContent: true,
            preload: path_1.default.join(__dirname, 'preload.js') // Ensure this is the main preload, not mirror-preload
        },
        show: false,
        resizable: false, // Prevent resizing to maintain 1920x1080
    ...
    <body>
      <div class="mirror-info">VJ Mirror Output (1920x1080)</div>
